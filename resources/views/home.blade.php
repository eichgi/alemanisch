...
@section('content')
    ...
    <div class="page-header" data-parallax="true" style="background-image: url('img/bruno-abatti.jpg');">
        <div class="filter"></div>
        <div class="container">
            <div class="motto text-center">
                <h1>Alemannisch</h1>
                <h3>Aprende Alemán</h3>
                <br/>
                ...
                <button type="button" class="btn btn-outline-neutral btn-round">Entrar</button>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-8 ml-auto mr-auto">
                        ...
                        <h5 class="description">This is the paragraph where you can write more details about your
                                                ...
                                                by
                                                this time, the user is curious, otherwise he wouldn't scroll to get
                                                here.
